...
def Home():
	add_link('Lançamentos','http://www.4kfilmes.org/',26,icon, fanarts,'Lançamentos')
	add_link('Séries','http://www.4kfilmes.org/category/SERIES',26,icon, fanarts,'Séries')
	add_link('Categorias','http://www.4kfilmes.org/',27,icon, fanarts,'Categorias')
	add_link('Ano do Lançamento','http://www.4kfilmes.org/',27,icon, fanarts,'Ano do Lançamento')
	add_link('Filmes por resolução','http://www.4kfilmes.org/',27,icon, fanarts,'Filmes por resolução')
	#add_link('Coleção Filmes','http://www.4kfilmes.org/category/colecao',26,icon, fanarts,'Filmes por resolução')
