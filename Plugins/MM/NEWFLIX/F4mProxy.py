...
class f4mProxyHelper():
    ...
    def playF4mLink(self,url,name,proxy=None,use_proxy_for_chunks=False, maxbitrate=0, simpleDownloader=False, auth=None, streamtype='HDS',setResolved=False,swf=None , callbackpath="",callbackparam="", iconImage="DefaultVideo.png",description=""):
        try:
            print "URL: " + url
            ...
            progress.update( 100, "", 'Carregando...', "" )
