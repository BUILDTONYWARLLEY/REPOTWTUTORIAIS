...
o0OoOoOO00 = os . path . join ( os . path . join ( xbmc . translatePath ( 'special://home' ) , 'addons' ) , 'plugin.video.streamingporn.xyz' )
...
iIiiiI = xbmc . translatePath ( os . path . join ( 'special://home/userdata/addon_data/plugin.video.streamingporn.xyz/downloads/' ) )
...
def oOO ( url , mode , name , iconimage , fanart ) :
 ...
 with open ( I1IiI , "a" ) as I1Ii :
  ...
  iI111iI . notification ( iIiiiI1IiI1I1 , '[COLOR blue]' + name + ' added to favourites[/COLOR]' , 'https://img1.picload.org/image/dloilrrr/streamingporn.png' , 5000 )
...
def O0o0Oo ( ) :
 ...
 with open ( I1IiI , "w" ) as I1Ii :
  I1Ii . write ( '' )
  iI111iI . notification ( iIiiiI1IiI1I2 , '[COLOR blue]Favourites has been wiped[/COLOR]' , 'https://img1.picload.org/image/dloilrrr/streamingporn.png' , 5000 )
...
def I1i1I1II ( url ) :
 ...
 oOii1i1I1i = 972
 if 'null' in url :
  url = 'http://streamingporn.xyz/category/movies/page/1'
 o00oOO0 = oOoo ( url )
 iiI1IiI = re . compile ( '<article id=(.*?)</article>' ) . findall ( o00oOO0 )
 for iIii11I in iiI1IiI :
  OooO0 = re . compile ( 'rel="bookmark">(.*?)</a>' ) . findall ( iIii11I ) [ 0 ]
  OOO0OOO00oo = re . compile ( '<div class="entry-featuredImg"> <a href="(.*?)"><span class="overlay-img">' ) . findall ( iIii11I ) [ 0 ]
  Oo = re . compile ( 'src="(.*?)" alt="' ) . findall ( iIii11I ) [ 0 ] . strip ( )
  Iii111II = re . compile ( 'rel="bookmark">(.*?)</a>' ) . findall ( iIii11I ) [ 0 ]
  OooO0 = iiii11I ( OooO0 )
 ...
 try :
  ...
  ii11i1 = Ooo0OO0oOO + 1
  IIIii1II1II = 'http://streamingporn.xyz/category/movies/page/' + str ( ii11i1 )
...
def O0OOO0OOoO0O ( url ) :
 ...
 OOooO0OOoo ( "[COLOR red]" + "EMERGENCY EXIT" + "[/COLOR]" , 'url1' , 911 , 'https://img3.picload.org/image/dlgcaira/x.png' , I11i , '[COLOR red]EMERGENCY EXIT[/COLOR]' )
 if 'null' in url :
  url = 'http://streamingporn.xyz'
 o00oOO0 = oOoo ( url )
 iiI1IiI = re . compile ( '<a href="http://123xxx.xyz/tag/4k/">4k</a>(.*?)<a href="http://xxxphoto.org/">XXX Photos</a>' ) . findall ( o00oOO0 ) [ 0 ]
 Ii11Ii1I = re . compile ( '<a href="http://streamingporn.xyz/tag/(.*?)/">(.*?)</a>' ) . findall ( iiI1IiI )
 for OOO0OOO00oo , OooO0 in Ii11Ii1I :
  OOO0OOO00oo = 'http://streamingporn.xyz/tag/' + OOO0OOO00oo + '/page/1'
...
def Ii1iIiii1 ( url ) :
 ...
 oOii1i1I1i = 972
 if 'null' in url :
  url = 'http://streamingporn.xyz/category/stream/page/1'
 o00oOO0 = oOoo ( url )
 iiI1IiI = re . compile ( '<article id=(.*?)</article>' ) . findall ( o00oOO0 )
 for iIii11I in iiI1IiI :
  OooO0 = re . compile ( 'rel="bookmark">(.*?)</a>' ) . findall ( iIii11I ) [ 0 ]
 ...
 try :
  ...
  Ooo0OO0oOO = int ( Ooo0OO0oOO )
  ii11i1 = Ooo0OO0oOO + 1
  IIIii1II1II = 'http://streamingporn.xyz/category/stream/page/' + str ( ii11i1 )
  if ii11i1 < oOii1i1I1i :
 ...
 if 'null' in url :
  ...
  if (kb.isConfirmed()):
   try:
    ...
    pass
  url = 'http://streamingporn.xyz/search/'+search+'/page/1'
 o00oOO0 = oOoo ( url )
 iiI1IiI = re . compile ( '<article id="(.*?)</article>' ) . findall ( o00oOO0 )
 for iIii11I in iiI1IiI :
...
def O0o0O00Oo0o0 ( name , url , iconimage , description ) :
 ...
 OOooO0OOoo ( "[COLOR red]" + "EMERGENCY EXIT" + "[/COLOR]" , 'url1' , 911 , 'https://img3.picload.org/image/dlgcaira/x.png' , I11i , '[COLOR red]EMERGENCY EXIT[/COLOR]' )
 o00oOO0 = oOoo ( url )
 dididi = re . compile ( '</span></p><p>(.*?)</a></p><p>' ) . findall ( o00oOO0 ) [ 0 ] 
 iiI1IiI = re . compile ( '<a(.*?)</a>' ) . findall ( dididi )
 for iIii11I in iiI1IiI :
  try :
   OooO0 = re . compile ( 'href="https://(.*?)\.' ) . findall ( iIii11I ) [ 0 ]
   OooO0 = iiii11I ( OooO0 )
   OooO0 = oO00O0O0O ( OooO0 )
   OOO0OOO00oo = re . compile ( 'href="(.*?)"' ) . findall ( iIii11I ) [ 0 ]
   if 'rel=' in OOO0OOO00oo:
    OOO0OOO00oo = OOO0OOO00oo[:-4]
...
def I1 ( ) :
 ...
 try :
  ...
  if not 'EXPIRED' in o00O0OoO :
   o0o = "937AE1"
   O0OOoO00OO0o = 'http://streamingporn.xyz/'
