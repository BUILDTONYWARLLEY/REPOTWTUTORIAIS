...
def SKindex():
    addDir('[B][COLOR lime]| Favourites[/COLOR][/B]','[B][COLOR lime]| Favourites[/COLOR][/B]',4,'https://i.imgur.com/t3WvzDE.png',FANART,'','','','')
    getData(Base,FANART)
...
def getSources():
        try:
            if os.path.exists(favorites) == True:
                addDir('[B][COLOR lime]| Favourites[/COLOR][/B]','[B][COLOR lime]| Favourites[/COLOR][/B]',4,'https://i.imgur.com/t3WvzDE.png' , os.path.join(home, 'fanart.gif'),FANART,'','','','')
            if os.path.exists(alive_source)==True:
