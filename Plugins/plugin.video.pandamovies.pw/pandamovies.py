...
o0OO00 = 'plugin.video.pandamovies.pw'
oi1000 = 'plugin.video.pandamovies.pw'
oo = Addon ( o0OO00 , sys . argv )
i1iII1IiiIiI1 = xbmcaddon . Addon ( id = o0OO00 )
iIiiiI1IiI1I1 = '[COLOR blue][B]Pandamovies[/B][/COLOR]'
iIiiiI1IiI1I2 = '[COLOR blue][B]Pandamovies[/B][/COLOR]'
o0OoOoOO00 = os . path . join ( os . path . join ( xbmc . translatePath ( 'special://home' ) , 'addons' ) , 'plugin.video.pandamovies.pw' )
...
iIiiiI = xbmc . translatePath ( os . path . join ( 'special://home/userdata/addon_data/plugin.video.pandamovies.pw/downloads/' ) )
...
def oOO ( url , mode , name , iconimage , fanart ) :
 ...
 with open ( I1IiI , "a" ) as I1Ii :
  ...
  iI111iI . notification ( iIiiiI1IiI1I2 , '[COLOR blue]' + name + ' added to favourites[/COLOR]' , 'https://img3.picload.org/image/dloialaw/pandamovie.png' , 5000 )
...
def O0o0Oo ( ) :
 ...
 with open ( I1IiI , "w" ) as I1Ii :
  I1Ii . write ( '' )
  iI111iI . notification ( iIiiiI1IiI1I2 , '[COLOR blue]Favourites has been wiped[/COLOR]' , 'https://img3.picload.org/image/dloialaw/pandamovie.png' , 5000 )
...
def I1i1I1II ( url ) :
 ...
 oOii1i1I1i = 972
 if 'null' in url :
  url = 'https://pandamovies.pw/list-movies/page/1'
 o00oOO0 = oOoo ( url )
 iiI1IiI = re . compile ( '<div class="thumb">(.*?)<span class="overlay"></span>' ) . findall ( o00oOO0 )
 for iIii11I in iiI1IiI :
  OooO0 = re . compile ( 'title="(.*?)"' ) . findall ( iIii11I ) [ 0 ]
  OOO0OOO00oo = re . compile ( 'href="(.*?)">' ) . findall ( iIii11I ) [ 0 ]
  Oo = re . compile ( 'src="(.*?)"' ) . findall ( iIii11I ) [ 0 ] . strip ( )
  Iii111II = re . compile ( '<span class="long_min">(.*?)</span>' ) . findall ( iIii11I ) [ 0 ]
  OooO0 = iiii11I ( OooO0 )
 ...
 try :
  ...
  ii11i1 = Ooo0OO0oOO + 1
  IIIii1II1II = 'https://pandamovies.pw/list-movies/page/' + str ( ii11i1 )
...
def i1I1iI ( url ) :
 ...
 OOooO0OOoo ( "[COLOR red]" + "EMERGENCY EXIT" + "[/COLOR]" , 'url1' , 911 , 'https://img3.picload.org/image/dlgcaira/x.png' , I11i , '[COLOR red]EMERGENCY EXIT[/COLOR]' )
 if 'null' in url :
  url = 'https://pandamovies.pw/list-movies'
 o00oOO0 = oOoo ( url )
 iiI1IiI = re . compile ( '''<ul id="li60px" class="menuyears">(.*?)</ul>''' ) . findall ( o00oOO0 ) [ 0 ]
 Ii11Ii1I = re . compile ( 'href="(.*?)">(.*?)</a>' ) . findall ( iiI1IiI )
 for OOO0OOO00oo , OooO0 in Ii11Ii1I :
  OOO0OOO00oo = OOO0OOO00oo + '/page/1'
  I11II1i ( "[COLOR blue]" + OooO0 + "[/COLOR]" , 'https:'+OOO0OOO00oo , 3 , Oo , I11i , 'Year: ' + OooO0 )
 OOooO0OOoo ( "[COLOR red]" + "EMERGENCY EXIT" + "[/COLOR]" , 'url1' , 911 , 'https://img3.picload.org/image/dlgcaira/x.png' , I11i , '[COLOR red]EMERGENCY EXIT[/COLOR]' )
 IIIIIooooooO0oo ( )
...
def Oo0O0O0ooO0O ( url ) :
 ...
 OOooO0OOoo ( "[COLOR red]" + "EMERGENCY EXIT" + "[/COLOR]" , 'url1' , 911 , 'https://img3.picload.org/image/dlgcaira/x.png' , I11i , '[COLOR red]EMERGENCY EXIT[/COLOR]' )
 o00oOO0 = oOoo ( url )
 iiI1IiI = re . compile ( '<h1 class="h1catname">(.*?)<footer id="footer">' ) . findall ( o00oOO0 ) [ 0 ]
 iiI1IiI = re . compile ( '<div class="thumb">(.*?)<span class="overlay"></span>' ) . findall ( iiI1IiI )
 for iIii11I in iiI1IiI :
  OooO0 = re . compile ( 'title="(.*?)"' ) . findall ( iIii11I ) [ 0 ]
  OOO0OOO00oo = re . compile ( 'href="(.*?)"' ) . findall ( iIii11I ) [ 0 ]
  Oo = re . compile ( 'src="(.*?)"' ) . findall ( iIii11I ) [ 0 ] . strip ( )
...
def O0OOO0OOoO0O ( url ) :
 ...
 if 'null' in url :
  url = 'https://pandamovies.pw/list-movies'
 o00oOO0 = oOoo ( url )
 #iiI1IiI = re . compile ( '<ul class="menugen">(.*?)</ul>' ) . findall ( o00oOO0 ) [ 1 ]
 iiI1IiI = re . compile ( '''<ul class="menugen">(.*?)</ul>''' ) . findall ( o00oOO0 ) [ 0 ]
 Ii11Ii1I = re . compile ( 'href="(.*?)">(.*?)</a>' ) . findall ( iiI1IiI )
 for OOO0OOO00oo , OooO0 in Ii11Ii1I :
  OOO0OOO00oo = OOO0OOO00oo + '/page/1'
  I11II1i ( "[COLOR blue]" + OooO0 + "[/COLOR]" , 'https:'+OOO0OOO00oo , 3 , Oo , I11i , 'Genre: ' + OooO0 )
 IIIIIooooooO0oo ( )
 OOooO0OOoo ( "[COLOR red]" + "EMERGENCY EXIT" + "[/COLOR]" , 'url1' , 911 , 'https://img3.picload.org/image/dlgcaira/x.png' , I11i , '[COLOR red]EMERGENCY EXIT[/COLOR]' )
def oOOOoO0O00o0 ( url ) :
 ...
 oOii1i1I1i = 972
 if 'null' in url :
  url = 'https://pandamovies.pw/watch-clips-scenes-porn-movies-online-free/page/1'
 o00oOO0 = oOoo ( url )
 iiI1IiI = re . compile ( '<h1 class="h1catname">(.*?)<footer id="footer">' ) . findall ( o00oOO0 ) [ 0 ]
 iiI1IiI = re . compile ( '<div class="thumb">(.*?)<span class="overlay"></span>' ) . findall ( iiI1IiI )
 for iIii11I in iiI1IiI :
 ...
 try :
  ...
  Ooo0OO0oOO = int ( Ooo0OO0oOO )
  ii11i1 = Ooo0OO0oOO + 1
  IIIii1II1II = 'https://pandamovies.pw/watch-clips-scenes-porn-movies-online-free/page/' + str ( ii11i1 )
  if ii11i1 < oOii1i1I1i :
 ...
 if 'null' in url :
  ...
  if (kb.isConfirmed()):
   try:
    ...
    pass
  url = 'https://pandamovies.pw/search/'+search+'/page/1'
 o00oOO0 = oOoo ( url )
 iiI1IiI = re . compile ( '<div class="thumb">(.*?)<span class="overlay"></span>' ) . findall ( o00oOO0 )
 for iIii11I in iiI1IiI :
  OooO0 = re . compile ( '<a class="clip-link" title="(.*?)"' ) . findall ( iIii11I ) [ 0 ]
  OOO0OOO00oo = re . compile ( 'href="(.*?)">' ) . findall ( iIii11I ) [ 0 ]
  Oo = re . compile ( 'src="(.*?)"' ) . findall ( iIii11I ) [ 0 ] . strip ( )
  Iii111II = re . compile ( '<a class="clip-link" title="(.*?)"' ) . findall ( iIii11I ) [ 0 ]
  OooO0 = iiii11I ( OooO0 )
  Iii111II = iiii11I ( Iii111II )
  I11II1i ( "[COLOR blue]" + OooO0 + "[/COLOR]" , OOO0OOO00oo , 98 , Oo , I11i , Iii111II )
 try :
...
def O0o0O00Oo0o0 ( name , url , iconimage , description ) :
 ...
 OOooO0OOoo ( "[COLOR red]" + "EMERGENCY EXIT" + "[/COLOR]" , 'url1' , 911 , 'https://img3.picload.org/image/dlgcaira/x.png' , I11i , '[COLOR red]EMERGENCY EXIT[/COLOR]' )
 o00oOO0 = oOoo ( url )
 iiI1IiI = re . compile ( '<li><span(.*?)</li>' ) . findall ( o00oOO0 )
 for iIii11I in iiI1IiI :
  try :
...
def I1 ( ) :
 ...
 try :
  ...
  if not 'EXPIRED' in o00O0OoO :
   o0o = "937AE1"
   O0OOoO00OO0o = 'https://pandamovies.pw'
