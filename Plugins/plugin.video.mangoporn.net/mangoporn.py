...
o0OO00 = 'plugin.video.mangoporn.net'
oi1000 = 'plugin.video.mangoporn.net'
oo = Addon ( o0OO00 , sys . argv )
i1iII1IiiIiI1 = xbmcaddon . Addon ( id = o0OO00 )
iIiiiI1IiI1I1 = '[COLOR blue][B]Mangoporn[/B][/COLOR]'
iIiiiI1IiI1I2 = '[COLOR blue][B]Mangoporn[/B][/COLOR]'
o0OoOoOO00 = os . path . join ( os . path . join ( xbmc . translatePath ( 'special://home' ) , 'addons' ) , 'plugin.video.mangoporn.net' )
...
iIiiiI = xbmc . translatePath ( os . path . join ( 'special://home/userdata/addon_data/plugin.video.mangoporn.net/downloads/' ) )
...
def oOO ( url , mode , name , iconimage , fanart ) :
 ...
 with open ( I1IiI , "a" ) as I1Ii :
  ...
  iI111iI . notification ( iIiiiI1IiI1I2 , '[COLOR blue]' + name + ' added to favourites[/COLOR]' , 'https://img1.picload.org/image/dlocwwgw/icon.png' , 5000 )
...
def O0o0Oo ( ) :
 ...
 with open ( I1IiI , "w" ) as I1Ii :
  I1Ii . write ( '' )
  iI111iI . notification ( iIiiiI1IiI1I2 , '[COLOR blue]Favourites has been wiped[/COLOR]' , 'https://img1.picload.org/image/dlocwwgw/icon.png' , 5000 )
...
def o0o0oOOOo0oo ( ) :
 ...
 I11II1i ( "[COLOR white][B]C[COLOR blue]lips[/B][/COLOR]" , 'null' , 6 , Oo , I11i , '[COLOR blue]XXX Clips[/COLOR]' )
...
def I1i1I1II ( url ) :
 ...
 oOii1i1I1i = 972
 if 'null' in url :
  url = 'https://mangoporn.net/movies/page/1'
 o00oOO0 = oOoo ( url )
 iiI1IiI = re . compile ( '<h1>Movies</h1>(.*?)<div class="fixed-sidebar-blank">' ) . findall ( o00oOO0 ) [0]
 iiI1IiI = re . compile ( '<article id=(.*?)</article>' ) . findall ( iiI1IiI )
 for iIii11I in iiI1IiI :
  OooO0 = re . compile ( '<h4>(.*?)</h4>' ) . findall ( iIii11I ) [ 0 ]
  OOO0OOO00oo = re . compile ( '<a href="(.*?)">' ) . findall ( iIii11I ) [ 0 ]
  Oo = re . compile ( '<img src="(.*?)"' ) . findall ( iIii11I ) [ 0 ] . strip ( )
  Iii111II = re . compile ( '<div class="texto">(.*?)</div>' ) . findall ( iIii11I ) [ 0 ]
  OooO0 = iiii11I ( OooO0 )
 ...
 try :
  ...
  ii11i1 = Ooo0OO0oOO + 1
  IIIii1II1II = 'https://mangoporn.net/movies/page/' + str ( ii11i1 )
...
def i1I1iI ( url ) :
 ...
 OOooO0OOoo ( "[COLOR red]" + "EMERGENCY EXIT" + "[/COLOR]" , 'url1' , 911 , 'https://img3.picload.org/image/dlgcaira/x.png' , I11i , '[COLOR red]EMERGENCY EXIT[/COLOR]' )
 if 'null' in url :
  url = 'https://mangoporn.net/movies'
 o00oOO0 = oOoo ( url )
 iiI1IiI = re . compile ( '<ul class="releases scrolling">(.*?)</ul>' ) . findall ( o00oOO0 ) [ 0 ]
 Ii11Ii1I = re . compile ( '<li><a href="https://mangoporn.net/year/(.*?)/">(.*?)</a></li>' ) . findall ( iiI1IiI )
 for OOO0OOO00oo , OooO0 in Ii11Ii1I :
  OOO0OOO00oo = 'https://mangoporn.net/year/' + OOO0OOO00oo + '/page/1'
...
def O0OOO0OOoO0O ( url ) :
 ...
 OOooO0OOoo ( "[COLOR red]" + "EMERGENCY EXIT" + "[/COLOR]" , 'url1' , 911 , 'https://img3.picload.org/image/dlgcaira/x.png' , I11i , '[COLOR red]EMERGENCY EXIT[/COLOR]' )
 if 'null' in url :
  url = 'https://mangoporn.net/genres/'
 o00oOO0 = oOoo ( url )
 iiI1IiI = re . compile ( '<ul class="genres scrolling">(.*?)</ul>' ) . findall ( o00oOO0 ) [ 0 ]
 Ii11Ii1I = re . compile ( '<a href="https://mangoporn.net/genres/(.*?)/" >(.*?)</a>' ) . findall ( iiI1IiI )
 for OOO0OOO00oo , OooO0 in Ii11Ii1I :
  OOO0OOO00oo = 'https://mangoporn.net/genres/' + OOO0OOO00oo + '/page/1'
...
def Ii1iIiii1 ( url ) :
 ...
 oOii1i1I1i = 972
 if 'null' in url :
  url = 'https://mangoporn.net/xxxscenes/page/1'
 o00oOO0 = oOoo ( url )
 iiI1IiI = re . compile ( '<article id=(.*?)</article>' ) . findall ( o00oOO0 )
 for iIii11I in iiI1IiI :
  OooO0 = re . compile ( '<h4>(.*?)</h4>' ) . findall ( iIii11I ) [ 0 ]
 ...
 try :
  ...
  Ooo0OO0oOO = int ( Ooo0OO0oOO )
  ii11i1 = Ooo0OO0oOO + 1
  IIIii1II1II = 'https://mangoporn.net/xxxscenes/page/' + str ( ii11i1 )
  if ii11i1 < oOii1i1I1i :
 ...
 if 'null' in url :
  ...
  if (kb.isConfirmed()):
   try:
    ...
    pass
  url = 'https://mangoporn.net/search/'+search+'/page/1'
 o00oOO0 = oOoo ( url )
