#########################################
if 64 - 64: i11iIiiIii
import xbmc , xbmcaddon , xbmcgui , xbmcplugin , urllib , urllib2 , os , re , sys , base64 , json
...
o0OO00 = 'plugin.video.pornkino.to'
oi1000 = 'plugin.video.pornkino.to'
oo = Addon ( o0OO00 , sys . argv )
i1iII1IiiIiI1 = xbmcaddon . Addon ( id = o0OO00 )
iIiiiI1IiI1I1 = '[COLOR blue][B]Pornkino[/B][/COLOR]'
iIiiiI1IiI1I2 = '[COLOR blue][B]Pornkino[/B][/COLOR]'
o0OoOoOO00 = os . path . join ( os . path . join ( xbmc . translatePath ( 'special://home' ) , 'addons' ) , 'plugin.video.pornkino.to' )
...
iIiiiI = xbmc . translatePath ( os . path . join ( 'special://home/userdata/addon_data/plugin.video.pornkino.to/downloads/' ) )
...
def oOO ( url , mode , name , iconimage , fanart ) :
 ...
 with open ( I1IiI , "a" ) as I1Ii :
  ...
  iI111iI . notification ( iIiiiI1IiI1I1 , '[COLOR blue]' + name + ' added to favourites[/COLOR]' , 'https://img1.picload.org/image/dloiodli/pornkino.png' , 5000 )
...
def O0o0Oo ( ) :
 ...
 with open ( I1IiI , "w" ) as I1Ii :
  I1Ii . write ( '' )
  iI111iI . notification ( iIiiiI1IiI1I2 , '[COLOR blue]Favourites has been wiped[/COLOR]' , 'https://img1.picload.org/image/dloiodli/pornkino.png' , 5000 )
...
def o0o0oOOOo0oo ( ) :
 ...
 I11II1i ( "[COLOR white][B]M[COLOR blue]enu[/B][/COLOR]" , 'null' , 6 , 'https://img3.picload.org/image/dlgcaigi/home.png' , I11i , 'Back to [B][COLOR orange]RUB[/COLOR][COLOR blue] THE [/COLOR][COLOR orange]DUCK[/COLOR][/B] Menu' )
 I11II1i ( "[COLOR white][B]S[COLOR blue]earch[/B][/COLOR]" , 'null' , 7 , 'https://img3.picload.org/image/dloigrli/search.png' , I11i , '[COLOR blue]Search XXX[/COLOR]' )
 I11II1i ( "[COLOR white][B]M[COLOR blue]ovies[/B][/COLOR]" , 'null' , 1 , Oo , I11i , '[COLOR blue]XXX Movies[/COLOR]' )
 I11II1i ( "[COLOR white][B]C[COLOR blue]lips[/B][/COLOR]" , 'null' , 5 , Oo , I11i , '[COLOR blue]XXX Clips[/COLOR]' ) 
 I11II1i ( "[COLOR white][B]G[COLOR blue]enres[/B][/COLOR]" , 'null' , 4 , Oo , I11i , '[COLOR blue]XXX Sorted By Genre[/COLOR]' )
...
def I1i1I1II ( url ) :
 ...
 oOii1i1I1i = 972
 if 'null' in url :
  url = 'https://pornkino.to/page/1'
 o00oOO0 = oOoo ( url )
 iiI1IiI = re . compile ( '<article id="(.*?)</article>' ) . findall ( o00oOO0 )
 for iIii11I in iiI1IiI :
  OooO0 = re . compile ( 'title="(.*?)"' ) . findall ( iIii11I ) [ 0 ]
  OooO0 = OooO0.replace("&#8211;","-").replace("(720p)","")
  OOO0OOO00oo = re . compile ( '<a href="(.*?)"' ) . findall ( iIii11I ) [ 0 ]
  Oo = re . compile ( '<img class="cover sl_lazyimg" src="https://pornkino.to/wp-content/plugins/simple-lazyload/blank_1x1.gif" file="(.*?)" width="200">' ) . findall ( iIii11I ) [ 0 ] . strip ( )
  Iii111II = re . compile ( 'title="(.*?)"' ) . findall ( iIii11I ) [ 0 ]
  Iii111II = Iii111II.replace("&#8211;","-").replace("(720p)","")
 ...
 try :
  ...
  ii11i1 = Ooo0OO0oOO + 1
  IIIii1II1II = 'https://pornkino.to/page/' + str ( ii11i1 )
...
def Oo0O0O0ooO0O ( url ) :
 ...
 for iIii11I in iiI1IiI :
  OooO0 = re . compile ( 'title="(.*?)"' ) . findall ( iIii11I ) [ 0 ]
  OooO0 = OooO0.replace("&#8211;","-").replace("(720p)","").replace("(1080p)","")
  OOO0OOO00oo = re . compile ( '<a href="(.*?)"' ) . findall ( iIii11I ) [ 0 ]
  Oo = re . compile ( '<img class="cover sl_lazyimg" src="https://pornkino.to/wp-content/plugins/simple-lazyload/blank_1x1.gif" file="(.*?)" width="200">' ) . findall ( iIii11I ) [ 0 ] . strip ( )
  try :
   Iii111II = re . compile ( 'title="(.*?)"' ) . findall ( iIii11I ) [ 0 ]
   Iii111II = Iii111II.replace("&#8211;","-").replace("(720p)","").replace("(1080p)","")
  except :
   Iii111II = '[COLOR blue]No Film Description Found[/COLOR]'
  OooO0 = iiii11I ( OooO0 )
  Iii111II = iiii11I ( Iii111II )
  I11II1i ( "[COLOR blue]" + OooO0 + "[/COLOR]" , OOO0OOO00oo , 98 , Oo , I11i , Iii111II )
 try :
...
def O0OOO0OOoO0O ( url ) :
 ...
 if 'null' in url :
  url = 'https://pornkino.to'
 o00oOO0 = oOoo ( url )
 iiI1IiI = re . compile ( '<li class="cat-item cat-item-39">(.*?)</ul>' ) . findall ( o00oOO0 ) [ 0 ]
 Ii11Ii1I = re . compile ( '<a href="https://pornkino.to/(.*?)" data-wpel-link="internal">(.*?)</a>' ) . findall ( iiI1IiI )
 for OOO0OOO00oo , OooO0 in Ii11Ii1I :
  OOO0OOO00oo = 'https://pornkino.to/' + OOO0OOO00oo + '/page/1'
  I11II1i ( "[COLOR blue]" + OooO0 + "[/COLOR]" , OOO0OOO00oo , 3 , Oo , I11i , 'Genre: ' + OooO0 )
 IIIIIooooooO0oo ( )
 OOooO0OOoo ( "[COLOR red]" + "EMERGENCY EXIT" + "[/COLOR]" , 'url1' , 911 , 'https://img3.picload.org/image/dlgcaira/x.png' , I11i , '[COLOR red]EMERGENCY EXIT[/COLOR]' )
def oOOOoO0O00o0 ( url ) :
 ...
 oOii1i1I1i = 972
 if 'null' in url :
  url = 'https://pornkino.to/clips-scenes/page/1'
 o00oOO0 = oOoo ( url )
 iiI1IiI = re . compile ( '<article id="(.*?)</article>' ) . findall ( o00oOO0 )
 for iIii11I in iiI1IiI :
  OooO0 = re . compile ( 'title="(.*?)"' ) . findall ( iIii11I ) [ 0 ]
 ...
 try :
  ...
  Ooo0OO0oOO = int ( Ooo0OO0oOO )
  ii11i1 = Ooo0OO0oOO + 1
  IIIii1II1II = 'https://pornkino.to/clips-scenes/page/' + str ( ii11i1 )
  if ii11i1 < oOii1i1I1i :
 ...
 if 'null' in url :
  ...
  if (kb.isConfirmed()):
   try:
    ...
    pass
  url = 'https://pornkino.to/search/'+search+'/page/1'
 o00oOO0 = oOoo ( url )
 iiI1IiI = re . compile ( '<article id="(.*?)</article>' ) . findall ( o00oOO0 )
 for iIii11I in iiI1IiI :
  OooO0 = re . compile ( 'title="(.*?)"' ) . findall ( iIii11I ) [ 0 ]
  OOO0OOO00oo = re . compile ( '<a href="(.*?)"' ) . findall ( iIii11I ) [ 0 ]
  Oo = re . compile ( 'file="(.*?)"' ) . findall ( iIii11I ) [ 0 ] . strip ( )
  Iii111II = re . compile ( 'title="(.*?)"' ) . findall ( iIii11I ) [ 0 ]
  OooO0 = iiii11I ( OooO0 )
  Iii111II = iiii11I ( Iii111II )
  I11II1i ( "[COLOR blue]" + OooO0 + "[/COLOR]" , OOO0OOO00oo , 98 , Oo , I11i , Iii111II )
 try :
  Ooo0OO0oOO = url . split ( 'page/' ) [ - 1 ]
  IOoo0OO0oOO = url.rsplit('//')[-1].split('page')[0]
  Ooo0OO0oOO = int ( Ooo0OO0oOO )
  ii11i1 = Ooo0OO0oOO + 1
  IIIii1II1II = 'https://'+IOoo0OO0oOO+'page/' + str ( ii11i1 )
  if ii11i1 < oOii1i1I1i :
...
def O0o0O00Oo0o0 ( name , url , iconimage , description ) :
 ...
 OOooO0OOoo ( "[COLOR red]" + "EMERGENCY EXIT" + "[/COLOR]" , 'url1' , 911 , 'https://img3.picload.org/image/dlgcaira/x.png' , I11i , '[COLOR red]EMERGENCY EXIT[/COLOR]' )
 o00oOO0 = oOoo ( url )
 dididi = re . compile ( '<div class="entry_left">(.*?)<div class="entry_right">' ) . findall ( o00oOO0 ) [ 0 ]
 iiI1IiI = re . compile ( '<a(.*?)</a>' ) . findall ( dididi )
 for iIii11I in iiI1IiI :
  try :
   OooO0 = re . compile ( '<span>(.*?) Stream & DDL</span>' ) . findall ( iIii11I ) [ 0 ]
   OooO0 = iiii11I ( OooO0 )
   OooO0 = oO00O0O0O ( OooO0 )
   OOO0OOO00oo = re . compile ( 'href="(.*?)"' ) . findall ( iIii11I ) [ 0 ]
   dlc_save_name = re . compile ( 'https://filecrypt.cc/Container/(.*?)\.html' ) . findall ( OOO0OOO00oo ) [ 0 ]
   dlc_save_name = dlc_save_name + '.dlc'
   tmp_path = xbmc.translatePath("special://userdata/addon_data/plugin.video.pornkino.to/tmp/").decode("utf-8")
   if not os.path.exists(tmp_path):
    os.makedirs(tmp_path)
   else:
    pass
   if not os.path.isfile(tmp_path+dlc_save_name):
    dlc_url = oOoo ( OOO0OOO00oo )
    dlc_url = re . compile ( 'onclick="DownloadDLC(.*?)">' ) . findall ( dlc_url ) [ 0 ]
    dlc_url = dlc_url[:-3]
    dlc_url = dlc_url[2:]
    dlc_url = 'https://filecrypt.cc/DLC/' + dlc_url + '.dlc'
    r = requests.get(dlc_url)
    with open(tmp_path+dlc_save_name, 'wb') as f:
     f.write(r.content) 
   else:
    pass
   file = tmp_path+dlc_save_name
   with open(file , 'r') as dlc_file:
    dlc_data = dlc_file.read()
   headers = {'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.95 Safari/537.36'}
   payload = {"content": dlc_data}
   req = requests.post("http://dcrypt.it/decrypt/paste", payload, headers=headers)
   links = json.loads(req.content)
   OOO0OOO00oo = '\n'.join(links['success']['links']) 
...
def I1 ( ) :
 ...
 try :
  ...
  if not 'EXPIRED' in o00O0OoO :
   o0o = "937AE1"
   O0OOoO00OO0o = 'https://pornkino.to'
