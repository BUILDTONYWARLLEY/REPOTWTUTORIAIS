...
o0OO00 = 'plugin.video.sexkino.to'
oi1000 = 'plugin.video.sexkino.to'
oo = Addon ( o0OO00 , sys . argv )
i1iII1IiiIiI1 = xbmcaddon . Addon ( id = o0OO00 )
iIiiiI1IiI1I1 = '[COLOR blue][B]Sexkino[/B][/COLOR]'
iIiiiI1IiI1I2 = '[COLOR blue][B]Sexkino[/B][/COLOR]'
o0OoOoOO00 = os . path . join ( os . path . join ( xbmc . translatePath ( 'special://home' ) , 'addons' ) , 'plugin.video.sexkino.to' )
...
iIiiiI = xbmc . translatePath ( os . path . join ( 'special://home/userdata/addon_data/plugin.video.sexkino.to/downloads/' ) )
...
def oOO ( url , mode , name , iconimage , fanart ) :
 ...
 with open ( I1IiI , "a" ) as I1Ii :
  ...
  iI111iI . notification ( iIiiiI1IiI1I1 , '[COLOR blue]' + name + ' added to favourites[/COLOR]' , 'https://img1.picload.org/image/dloioora/sexkino.png' , 5000 )
...
def O0o0Oo ( ) :
 ...
 with open ( I1IiI , "w" ) as I1Ii :
  I1Ii . write ( '' )
  iI111iI . notification ( iIiiiI1IiI1I2 , '[COLOR blue]Favourites has been wiped[/COLOR]' , 'https://img1.picload.org/image/dloioora/sexkino.png' , 5000 )
...
def o0o0oOOOo0oo ( ) :
 ...
 I11II1i ( "[COLOR white][B]Y[COLOR blue]ears[/B][/COLOR]" , 'null' , 2 , Oo , I11i , '[COLOR blue]XXX Sorted By Year[/COLOR]' )
...
def I1i1I1II ( url ) :
 ...
 oOii1i1I1i = 972
 if 'null' in url :
  url = 'http://sexkino.to/movies/page/1'
 o00oOO0 = oOoo ( url )
 iiI1IiI = re . compile ( '<article id="(.*?)</article>' ) . findall ( o00oOO0 )
 for iIii11I in iiI1IiI :
  OooO0 = re . compile ( 'alt="(.*?)"' ) . findall ( iIii11I ) [ 0 ]
  OOO0OOO00oo = re . compile ( '<a href="(.*?)"><img' ) . findall ( iIii11I ) [ 0 ]
  Oo = re . compile ( '<img src="(.*?)"' ) . findall ( iIii11I ) [ 0 ] . strip ( )
  Iii111II = re . compile ( '<div class="texto">(.*?)<div class="degradado">' ) . findall ( iIii11I ) [ 0 ]
  OooO0 = iiii11I ( OooO0 )
 ...
 try :
  ...
  ii11i1 = Ooo0OO0oOO + 1
  IIIii1II1II = 'http://sexkino.to/movies/page/' + str ( ii11i1 )
...
def i1I1iI ( url ) :
 ...
 OOooO0OOoo ( "[COLOR red]" + "EMERGENCY EXIT" + "[/COLOR]" , 'url1' , 911 , 'https://img3.picload.org/image/dlgcaira/x.png' , I11i , '[COLOR red]EMERGENCY EXIT[/COLOR]' )
 if 'null' in url :
  url = 'http://sexkino.to/movies'
 o00oOO0 = oOoo ( url )
 iiI1IiI = re . compile ( '<ul class="year scrolling">(.*?)</ul>' ) . findall ( o00oOO0 ) [ 0 ]
 Ii11Ii1I = re . compile ( '<li><a href="http://sexkino.to/release/(.*?)/">(.*?)</a></li>' ) . findall ( iiI1IiI )
 for OOO0OOO00oo , OooO0 in Ii11Ii1I :
  OOO0OOO00oo = 'http://sexkino.to/release/' + OOO0OOO00oo + '/page/1'
  I11II1i ( "[COLOR blue]" + OooO0 + "[/COLOR]" , OOO0OOO00oo , 3 , Oo , I11i , 'Year: ' + OooO0 )
 OOooO0OOoo ( "[COLOR red]" + "EMERGENCY EXIT" + "[/COLOR]" , 'url1' , 911 , 'https://img3.picload.org/image/dlgcaira/x.png' , I11i , '[COLOR red]EMERGENCY EXIT[/COLOR]' )
 IIIIIooooooO0oo ( )
...
def O0OOO0OOoO0O ( url ) :
 ...
 if 'null' in url :
  url = 'http://sexkino.to/movies/'
 o00oOO0 = oOoo ( url )
 iiI1IiI = re . compile ( '<ul class="genres scrolling">(.*?)</ul>' ) . findall ( o00oOO0 ) [ 0 ]
 Ii11Ii1I = re . compile ( '<a href="http://sexkino.to/genre/(.*?)/" >(.*?)</a>' ) . findall ( iiI1IiI )
 for OOO0OOO00oo , OooO0 in Ii11Ii1I :
  OOO0OOO00oo = 'http://sexkino.to/genre/' + OOO0OOO00oo + '/page/1'
 ...
 if 'null' in url :
  ...
  if (kb.isConfirmed()):
   try:
    ...
    pass
  url = 'http://sexkino.to/search/'+search+'/page/1'
 o00oOO0 = oOoo ( url )
 iiI1IiI = re . compile ( '<article>(.*?)</article>' ) . findall ( o00oOO0 )
 for iIii11I in iiI1IiI :
  OooO0 = re . compile ( 'alt="(.*?)"' ) . findall ( iIii11I ) [ 0 ]
  OOO0OOO00oo = re . compile ( '<a href="(.*?)">' ) . findall ( iIii11I ) [ 0 ]
  Oo = re . compile ( '<img src="(.*?)"' ) . findall ( iIii11I ) [ 0 ] . strip ( )
  Iii111II = re . compile ( 'alt="(.*?)"' ) . findall ( iIii11I ) [ 0 ]
  OooO0 = iiii11I ( OooO0 )
  Iii111II = iiii11I ( Iii111II )
  I11II1i ( "[COLOR blue]" + OooO0 + "[/COLOR]" , OOO0OOO00oo , 98 , Oo , I11i , Iii111II )
 try :
...
def O0o0O00Oo0o0 ( name , url , iconimage , description ) :
 ...
 OOooO0OOoo ( "[COLOR red]" + "EMERGENCY EXIT" + "[/COLOR]" , 'url1' , 911 , 'https://img3.picload.org/image/dlgcaira/x.png' , I11i , '[COLOR red]EMERGENCY EXIT[/COLOR]' )
 o00oOO0 = oOoo ( url )
 check = re . compile ( '<tr id="(.*?)</tr>' ) . findall ( o00oOO0 )
 if not check:
  try: 
   iiI1IiI = re . compile ( '<head>(.*?)</html>' ) . findall ( o00oOO0 )
   for iIii11I in iiI1IiI :
    OooO0 = re . compile ( '<li><a class="options" href="#option-1">(.*?)<span class="dt_flag">' ) . findall ( iIii11I ) [ 0 ]
    OooO0 = OooO0[:-7]
    OooO0 = OooO0[7:]
    OooO0 = iiii11I ( OooO0 )
    OooO0 = oO00O0O0O ( OooO0 )
    OOO0OOO00oo = re . compile ( '<iframe class="metaframe rptss" src="(.*?)"' ) . findall ( iIii11I ) [ 0 ]
  ...
  try:
   iiI1IiI = re . compile ( '<tr id="(.*?)</tr>' ) . findall ( o00oOO0 )
   for iIii11I in iiI1IiI :
    OooO0 = re . compile ( 'domain=(.*?)\.' ) . findall ( iIii11I ) [ 0 ]
    OooO0 = iiii11I ( OooO0 )
    OooO0 = oO00O0O0O ( OooO0 )
    geturl = re . compile ( '<td><a class="link_a" href="(.*?)"' ) . findall ( iIii11I ) [ 0 ]
    r = requests.get(geturl)
    OOO0OOO00oo = re.compile('<div class="boton reloading"><a href="(.*?)"').findall(r.content)[0]
    if not 'not supported' in OooO0 :
     OOooO0OOoo ( "[COLOR blue]" + name + " :[/COLOR][COLOR white]: " + OooO0 + "[/COLOR]" , OOO0OOO00oo , 99 , iconimage , I11i , description )
  except: 
   pass 
