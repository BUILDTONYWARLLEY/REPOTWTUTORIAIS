...
addon_data_dir = xbmc.translatePath("special://home/addons/plugin.video.hunterfm/data")
...
def Categories():
	...
	AddDir("[COLOR white][B]Todas Estações de Radio[/B][/COLOR]", "favorites" ,30 ,os.path.join(iconsDir, "bright_yellow_star.png"))
